...
std::set<int> CheckPointer::phi_veloc_all;
std::set<int> CheckPointer::md_veloc_all;
void   *CheckPointer::veloc_p[100];
size_t CheckPointer::veloc_m_size[100];
int CheckPointer::veloc_d_size[100];

int CheckPointer::veloc_id=0;
