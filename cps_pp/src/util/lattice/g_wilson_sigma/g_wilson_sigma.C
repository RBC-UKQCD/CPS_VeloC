...
CPS_START_NAMESPACE
/*!\file
  \brief  Implementation of GwilsonSigma class.
...
// g_wilson.C
//
// GwilsonSigma is derived from Lattice and is relevant to the 
...
// Constructor
//------------------------------------------------------------------
GwilsonSigma::GwilsonSigma ()
{
  cname = "GwilsonSigma";
  char *fname = "GwilsonSigma()";
...
//------------------------------------------------------------------
GclassType GwilsonSigma::Gclass (void)
{
...
void GwilsonSigma::SigmaHeatbath ()
{
...
*/
//------------------------------------------------------------------
void GwilsonSigma::GforceSite (Matrix & force, int *x, int mu, Float *RePlaq)
{
...
//------------------------------------------------------------------
Float GwilsonSigma::GhamiltonNode (void)
{
...
//------------------------------------------------------------------------------
void GwilsonSigma::GactionGradient (Matrix & grad, int *x, int mu)
{
...
*/
void GwilsonSigma::AllStaple (Matrix & stap, const int *x, int mu)
{
