...
void decode_vml_all(void)
{
    ...
    decode_vml(quo_h_arg);
    encode_vml(quo_h_arg,0);
}
...
int main(int argc, char *argv[])
{
    ...
    AlgActionQuotient quo_h(mom, quo_h_arg);
    ...
    AlgIntSum sum2(sum, quo_h, sum_arg);

    //!< Construct numerical integrators
    AlgIntAB &ab1 = AlgIntAB::Create(mom, gauge, ab1_arg);
    AlgIntAB &ab2 = AlgIntAB::Create(ab1, sum2,   ab2_arg);
    //////////////////////////////////////////////////////////////////////
